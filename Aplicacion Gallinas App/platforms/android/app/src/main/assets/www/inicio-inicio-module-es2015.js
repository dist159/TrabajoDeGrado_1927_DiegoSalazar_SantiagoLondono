...
/* harmony import */ var _servicios_g_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../servicios-g.service */ "./src/app/servicios-g.service.ts");
/* inicio.page ****************************************************************/
/*                                                                            */
        ...
        this.Servicios.userState().subscribe((user) => {
            if (user) {
                this.Servicios.getUsuario(user.uid).subscribe(res => {
                    const usuarioto = res.payload.val();
                    if (usuarioto !== null) {
